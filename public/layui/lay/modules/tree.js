...
layui.define("form", function(e) {
                    ...
                    var c = l.children && l.children.length > 0,
                        ...
                        h = i(
                            [
                                ...
                                (l.spread ? " layui-tree-spread" : "") +
                                (l.checked ? " layui-tree-checkedFirst" : "") +
                                '">',
                                "<div " +
                                (r.drag && !l.fixed ? 'draggable="true"' : "") +
                                ...
                                (function() {
                                    return r.isJump && l.href ?
                                        ...
                                        p +
                                        '">' +
                                        (l.title || l.label || r.text.defaultNodeName) +
                                        "</a>" :
                                        '<span class="' +
                                        p +
                                        (l.disabled ? " " + d : "") +
                                ...
                                (function() {
                                    ...
                                    return (
                                        r.edit === !0 && (r.edit = ["update", "del"]),
                                        "object" == typeof r.edit ?
            ...
            (g.prototype.spread = function(e, a) {
                ...
                k.on("click", function(i) {
                        var a = e.children("." + y),
                            n = k.children(".layui-icon")[0] ?
                            k.children(".layui-icon") :
                            k.find(".layui-tree-icon").children(".layui-icon");
                        if (a[0]) {
                            if (e.hasClass(v))
                    ...
                    m.on("click", function() {
                        ...
                        n.hasClass(d) ||
                            ((g = e.hasClass(v) ?
                                    ...
                                    "close" :
                                    "open"),
                                r.click && r.click({ elem: e, state: g, data: a }));
                    });
            }),
                ...
                var t = function(e) {
                    if (e.parents("." + s)[0]) {
                        ...
                        r
                            ?
                            l.prop("checked", r) :
                            (a.find('input[name="layuiTreeCheck"]').each(function() {
                                    this.checked && (i = !0);
                                }),
                                i || l.prop("checked", !1)),
                            t(n);
            ...
            (g.prototype.checkClick = function(e, a) {
                ...
                t.on("click", 'input[name="layuiTreeCheck"]+', function(l) {
                    ...
                    t.prop("disabled") ||
                        (n.setCheckbox(e, a, t),
                            r.oncheck && r.oncheck({ elem: e, checked: d, data: a }));
                });
            }),
            (g.prototype.operate = function(e, a) {
                    var n = this,
                        ...
                        l = e.children("." + u),
                        d = l.children("." + f);
                    l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function(
                            l
                        ) {
                            layui.stope(l);
                            var f = i(this).data("type"),
                                ...
                                if (r.customOperate) {
                                    ...
                                    if ("add" == f) {
                                        g[0] ||
                                            (r.showLine ?
                                                (d.find("." + c).addClass("layui-tree-icon"),
                                                    d
                                                    .find("." + c)
                                                    .children(".layui-icon")
                                                    .addClass(o)
                                                    .removeClass("layui-icon-file")) :
                                                d.find(".layui-tree-iconArrow").removeClass(t),
                                                e.append('<div class="layui-tree-pack"></div>'));
                                        var b = r.operate && r.operate(x),
                                            w = {};
                                        if (
                                            ((w.title = r.text.defaultNodeName),
                                                (w.id = b),
                                                n.tree(e.children("." + y), [w]),
                                                r.showLine)
                                        )
                                            if (g[0])
                                                g.hasClass(k) || g.addClass(k),
                                                ...
                                                layui.each(T, function(e, a) {
                                                    ...
                                                    1 == L ?
                                                    (T.children("." + y).addClass(m),
                                                        T.children("." + y)
                                                        .children("." + s)
                                                        .removeClass(C),
                                                        e.children("." + y).addClass(m),
                                                        N.removeClass(k),
                                                        N.children("." + s)
                                                        .last()
                                                        .children("." + y)
                                        ...
                                        if (
                                            (r.operate && r.operate(x),
                                                (x.status = "remove"), !e.prev("." + s)[0] && !e.next("." + s)[0] && !e.parent("." + y)[0])
                                        )
                                            ...
                                            if (r.showLine) {
                                                ...
                                                layui.each(T, function(e, a) {
                                                    ...
                                                    (g[0] ||
                                                        ...
                                                        .next()[0] ||
                                                        e.prev("." + s).addClass(C)) :
                                                    !e.next()[0] && e.hasClass(C) && e.prev().addClass(C);
                                            }
                                        } else {
                    ...
                    e.elem.on("dragstart", "." + u, function() {
                        ...
                        e.elem.on("dragend", "." + u, function(n) {
                            ...
                            var S = function(n) {
                                ...
                                if (1 == H)
                                    a.showLine ?
                                    (n.find("." + c).removeClass("layui-tree-icon"),
                                        n
                                        .find("." + c)
                                        .children(".layui-icon")
                                        .removeClass(h)
                                ...
                                if (0 != i(this).height()) {
                                        ...
                                        if (
                                            (i(this).children("." + y)[0] ||
                                                (a.showLine ?
                                                    ...
                                                    .removeClass(t),
                                                    i(this).append('<div class="layui-tree-pack"></div>')),
                                                i(this)
                                                .children("." + y)
                                                .append(d),
                                                S(A),
                                            ...
                                            if (
                                                ...
                                                d.prev("." + s).hasClass(C) ?
                                                (d.prev("." + s).removeClass(C), d.addClass(C)) :
                                                (d.removeClass(
                                    ...
                                    if (r < n) {
                                        if ((i(this).before(d), S(A), a.showLine)) {
                                            ...
                                            if (b[0]) {
                                                ...
                                                layui.each(h, function(e, a) {
                                                    ...
                                                    .children("." + s)
                                                    .last()
                                                    .addClass(C), !T.parent("." + y)[0] && T.next()[0] && L.removeClass(C);
                                            } else
                                                T.hasClass(k) || T.addClass(k),
                                        ...
                                        if (
                                            T[0] &&
                                            a.showCheckbox &&
                                            T.children("." + u).find('input[name="layuiTreeCheck"]')[0]
                                            .checked
                                        ) {
                                            var x = d.children("." + u);
                                            x.find('input[name="layuiTreeCheck"]+').click();
                                        ...
                                        return (
                                            a.dragend &&
                                            a.dragend("拖拽成功，插入目标节点上方", d, i(this)), !1
                                        );
                                    }
                                    if (r > w)
                                        return (
                                            ...
                                            .last()
                                            .addClass(C),
                                            a.dragend && a.dragend("拖拽成功，插入最外层节点", d, e.elem), !1
                                        );
                                }
                            });
                        });
                            ...
                            layui.each(n, function(e, n) {
                                if (r.id == n) {
                                    ...
                                    return (
                                        delete t.children,
                                        a.push(t),
                                        r.children && ((t.children = []), l(r.children, t.children)), !0
                                    );
                                }
                            });
                        });
